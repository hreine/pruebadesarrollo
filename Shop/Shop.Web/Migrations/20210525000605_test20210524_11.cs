...
{
    public partial class test20210524_11 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSurName = table.Column<string>(maxLength: 30, nullable: true),
                    Cellphonenumber = table.Column<string>(maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSurname = table.Column<string>(maxLength: 50, nullable: false),
                    Cellphonenumber = table.Column<string>(maxLength: 50, nullable: false),
                    Address = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartMaster", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceHeader_Customer_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartMasterId = table.Column<int>(nullable: true),
                    MechanicalId = table.Column<int>(nullable: true),
                    Note = table.Column<string>(maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceLine_Mechanical_MechanicalId",
                        column: x => x.MechanicalId,
                        principalTable: "Mechanical",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceLine_PartMaster_PartMasterId",
                        column: x => x.PartMasterId,
                        principalTable: "PartMaster",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceLine_ServiceHeader_ServiceHeaderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceHeader_CustomerId",
                table: "ServiceHeader",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceLine_MechanicalId",
                table: "ServiceLine",
                column: "MechanicalId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceLine_PartMasterId",
                table: "ServiceLine",
                column: "PartMasterId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceLine_ServiceHeaderId",
                table: "ServiceLine",
